...
def _master_to_dict(m: CompanyMaster, already_in_project: bool = False) -> dict:
    return {
        ...
        "base_flag": getattr(m, "base_flag", False),
        "makeshop_flag": getattr(m, "makeshop_flag", False),
        "futureshop_flag": getattr(m, "futureshop_flag", False),
        "stores_flag": getattr(m, "stores_flag", False),
    ...
    for domain in domain_list:
        ...
        try:
            company = Company(
                ...
                base_flag=getattr(master, "base_flag", None) or False,
                makeshop_flag=getattr(master, "makeshop_flag", None) or False,
                futureshop_flag=getattr(master, "futureshop_flag", None) or False,
                stores_flag=getattr(master, "stores_flag", None) or False,
